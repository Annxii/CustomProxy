...
namespace CustomProxy
{
    class CustomProxy<T>
    {
        ...
        static CustomProxy()
        {
            ...
            module = asm.DefineDynamicModule("Anx.DynamicProxies");
        }
        ...
        private static Type CreateDecorator(string name)
        {
            ...
            var instanceField = type.DefineField("instance", typeof(T), FieldAttributes.Private | FieldAttributes.InitOnly);
            DefineConstructor(type, originalType, instanceField);
        ...
        private static void DefineConstructor(TypeBuilder type, Type originalType, FieldInfo instanceField)
        {
